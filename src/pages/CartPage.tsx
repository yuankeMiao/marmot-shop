  ...
  return (
    <div className="py-8 px-4">
      ...
      <div className="flex flex-col lg:flex-row gap-8 mb-12">
        <div className="w-full h-full lg:w-2/3 bg-gray-100 dark:bg-gray-800 rounded-xl">
        ...
        <div className="w-full h-80 lg:w-1/3 bg-gray-100 dark:bg-gray-800 rounded-xl p-8 ">
